...
* Actively contribute to the CCGN in some way (e.g., participating in a [CC Network Platform](https://github.com/creativecommons/global-network-strategy#cc-network-platforms))
